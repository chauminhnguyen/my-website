                ...
                transition={{
                    ...
                    <div className="project-info">
                        ...
                        <div className="icon">
                            ...
                            {jsonData['projects'][index]['github_link'] !=  "" &&
                                <a href={jsonData['projects'][index]['github_link']}><i>
                            ...
                            {jsonData['projects'][index]['gitlab_link'] != "" &&
                                <a href={jsonData['projects'][index]['gitlab_link']}><i>
                                    <img src="/home/gitlab.png" alt="" />
                                </i></a>
                            }

                            {jsonData['projects'][index]['web_link'] != "" &&
                                <a href={jsonData['projects'][index]['web_link']}><i>
